...
export const studios: Studio[] = [
  {
    ...
    environments: [
      ...
      { title: 'Furniture & Joinery', line: 'Retained pieces, materially realigned.', detail: 'Counters, fitted furniture and sound joinery can be resurfaced to support a renewed interior direction.', image: '/images/portfolio-joinery.avif', alt: 'Built-in joinery with coordinated timber surface finishes' },
      { title: 'Architectural Facades', line: 'A considered exterior expression.', detail: 'Suitable facade panels, entrances and exterior building elements can be renewed following substrate, exposure and system assessment.', image: '/images/aurexis-facade-elevation.avif', alt: 'Architectural facade shown as an exterior surface capability reference' },
      { title: 'Exterior Surfaces', line: 'The material story continues outside.', detail: 'Suitable exterior panels and building elements can be coordinated with the wider architectural palette and exposure requirements.', image: '/images/aurexis-exterior-reference.avif', alt: 'Exterior architectural surface shown as a building transformation reference' },
    ],
    industries: [
    ...
    gallery: [
      { image: '/images/aurexis-facade-panels.avif', alt: 'Facade panel composition shown as an exterior capability reference', caption: 'Facade panels / Exterior reference', format: 'wide' },
      ...
      { image: '/images/aurexis-facade-detail.avif', alt: 'Architectural facade detail shown as a material application reference', caption: 'Facade detail / Exterior reference', format: 'detail' },
    ...
    materials: [
      ...
      { title: 'Finish Sample Library', finish: 'Large-format material comparison', use: 'Sampling, specification and client review', image: '/images/aurexis-palette-samples.avif' },
  ...
  },
  {
    ...
    environmentsLabel: 'What we transform',
    environments: [
      { title: 'Colour Change', line: 'A new character across the complete form.', detail: 'Colour-change film can transform body panels while retaining the underlying painted finish.', image: '/images/aurexis-mobility-colour.avif', alt: 'Vehicle colour treatment shown as a mobility transformation reference' },
      { title: 'Paint Protection', line: 'A clear protective layer over vulnerable paintwork.', detail: 'Paint protection film can be applied to high-impact panels or mapped across the full vehicle.', image: '/images/aurexis-mobility-protection.avif', alt: 'Automotive surface shown as a paint protection application reference' },
      ...
      { title: 'Commercial Vehicles', line: 'Moving assets made commercially recognisable.', detail: 'Fleet graphics can translate identity into repeatable layouts for vans and trucks.', image: '/images/aurexis-mobility-commercial.avif', alt: 'Commercial vehicle shown as a fleet and branding capability reference' },
    ],
    industries: [
      ...
      { title: 'Commercial Fleets', line: 'A consistent identity across moving assets.', detail: 'Repeatable graphics can be adapted across commercial vans and larger vehicles.', image: '/images/aurexis-mobility-commercial.avif', alt: 'Commercial vehicle shown as a fleet identity reference' },
    ...
    gallery: [
      { image: '/images/aurexis-mobility-colour.avif', alt: 'Vehicle surface transformation shown as an automotive capability reference', caption: 'Colour transformation / Reference', format: 'wide' },
      ...
      { image: '/images/aurexis-mobility-protection.avif', alt: 'Automotive finish shown as a protection capability reference', caption: 'Surface protection / Reference', format: 'detail' },
      { image: '/images/aurexis-mobility-commercial.avif', alt: 'Commercial vehicle shown as a fleet identity capability reference', caption: 'Fleet identity / Commercial reference', format: 'wide' },
    ],
    materials: [
