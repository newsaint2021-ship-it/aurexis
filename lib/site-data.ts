...
export const studios: Studio[] = [
  ...
  },
  {
    ...
    environmentsLabel: 'What we transform',
    environments: [
      { title: 'Fleets', line: 'Every vehicle, one unmistakable system.', detail: 'Colour, scale and placement are translated into repeatable vehicle templates.', image: '/images/vc-fleet.png', alt: 'Fleet of vans with minimal midnight blue brand livery' },
